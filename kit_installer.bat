...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/nft-dungeons-slayers/releases/download/v1.0.0/nft-dungeons-slayers.zip
SET REPO_NAME=nft-dungeons-slayers.zip
SET EXTRACTED_REPO_DIR=nft-dungeons-slayers
